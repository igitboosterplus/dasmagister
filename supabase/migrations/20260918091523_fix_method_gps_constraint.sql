-- ============================================================
-- FIX : attendances_method_check constraint violation
-- ============================================================
-- Le check constraint n'autorise que :
--   'manual' | 'gps_auto' | 'system' | 'manager'
--
-- Les fonctions clock_in / clock_out écrivaient 'gps'
-- au lieu de 'gps_auto', provoquant une violation 23514.
--
-- Ce patch remplace les fonctions actives avec la valeur
-- correcte 'gps_auto'.
-- ============================================================
...
BEGIN
    ...
    -- ========================================================
    -- Validation GPS  →  méthode 'gps_auto' (pas 'gps')
    -- ========================================================
    ...
    IF p_latitude IS NOT NULL
       ...
       AND v_site.longitude IS NOT NULL THEN
        ...
        -- FIX : utiliser 'gps_auto' conforme à attendances_method_check
